                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool-right">
                                    ...
                                    <a href="/category?action=add" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                    ...
                                    <tr class="tr-shadow">
                                        ...
                                        <td>
                                            <div class="table-data-feature">
                                                ...
                                                <a href="/category?action=update&id=${cate.id}" class="item" data-toggle="tooltip" data-placement="top"
                                                   title="Edit">
                                                    <i class="zmdi zmdi-edit"></i>
                                                </a>
                                                <a href="/category?action=delete&id=${cate.id}" class="item" data-toggle="tooltip" data-placement="top"
