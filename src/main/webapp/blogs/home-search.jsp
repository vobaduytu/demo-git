                ...
                <div class="col-3 search-top">
                    ...
                    <form action="home?action=search" method="post" class="search-form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="searchs"
            ...
            <div class="collapse navbar-collapse" id="navbarMenu">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="home?action=category&id=${categorys.id}"
                           id="dropdown05" data-toggle="dropdown"
            ...
            <div class="col-md-12 col-lg-8 main-content">
                <div class="row mb-5 mt-5">
                    <div class="col-md-12">
                        ...
                        <c:forEach items="${postSearch}" var="post">
