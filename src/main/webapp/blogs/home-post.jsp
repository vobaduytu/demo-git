    ...
    <div class="container">
        ...
        <div class="row blog-entries">
            <div class="col-md-12 col-lg-8 main-content">
                <h1 class="mb-4">${postt.shortContent}</h1>
                <div class="post-meta">
                    <span class="category">${postt.category.title}</span>
                    <span class="mr-2">${postt.createDate}</span> &bullet;
                    <span class="ml-2"><span class="fa fa-comments"></span> 3</span>
                </div>
                <div class="post-content-body">
                    <div class="row mb-5">
                        <div class="col-md-12 mb-4 element-animate">
                            <img src="${postt.image}" alt="Image placeholder" class="img-fluid">
                        </div>

                    </div>
                    <p>${postt.fullContent}</p>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <a href="home?action=postList&id=${post.id}" class="a-block d-flex align-items-center height-md" style="background-image: url(${post.image}); ">
                    <div class="text">
                        <div class="post-meta">
