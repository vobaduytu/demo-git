                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="row ml-3 mb-3">
                            <a href="post" type="button" class="btn btn-primary">Exit</a>
                        </div>
                    </div>
                    <div class="row">
                        <c:if test="${mess!=null}">
                    ...
                    <div class="row">
                        <!-- FORM ADD-->
                        <div class="col-12 col-md-12">
                            <form method="post" class="form-horizontal" action="/post?action=update&id=${post.id}">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" name="title" id="title" placeholder="Title"
                                                   required class="form-control" value="${post.title}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="shortContent" required name="shortContent"
                                                   placeholder="shortContent" value="${post.shortContent}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="fullContent" class=" form-control-label">Full Content</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="fullContent" required name="fullContent"
                                                   placeholder="fullContent" value="${post.fullContent}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                            ...
                                            <select name="user" id="user" class="form-control-sm form-control">
                                                <c:forEach items="${userList}" var="user">
                                                    <c:if test="${post.user.id == user.id}">
                                                        <option value="${post.user.id}" selected>${user.fullname}</option>
                                                    </c:if>
                                                    <c:if test="${post.user.id != user.id}">
                                            ...
                                            <select name="category" id="category" class="form-control-sm form-control">
                                                <c:forEach items="${categoryList}" var="cate">
                                                    <c:if test="${post.category.id == cate.id}">
                                                        <option value="${post.category.id}" selected>${cate.title}</option>
                                                    </c:if>
                                                    <c:if test="${post.category.id != cate.id}">
