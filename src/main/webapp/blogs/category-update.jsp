                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="row ml-3 mb-3">
                            <a href="category" type="button" class="btn btn-primary">Exit</a>
                        </div>
                    </div>
                    <div class="row">
                        <c:if test="${mess!=null}">
                    ...
                    <div class="row">
                        <!-- FORM ADD-->
                        <div class="col-12 col-md-12">
                            <form method="post" class="form-horizontal" action="/category?action=update&id=${category.id}">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" name="title" id="title" placeholder="Title"
                                                   required class="form-control" value="${category.title}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
