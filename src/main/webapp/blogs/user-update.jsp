            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <!-- FORM ADD-->
                        <div class="col-12 col-md-12">
                            <form method="post" class="form-horizontal" action="/user?action=update&id=${user.id}">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="alias" required name="alias"
                                                   placeholder="alias" value="${user.alias}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <c:if test="${ user.id != 1}">
                                        ...
                                        <div class="col-12 col-md-9">
                                           ...
                                           <c:if test="${1 == user.role}">
                                               ...
                                               <option value="3">User</option>
                                                ...
                                                <c:if test="${2 == user.role}">
                                                    <option value="1">Admin</option>
                                                    <option value="2" selected>Staff</option>
                                                    <option value="3">User</option>
                                                </c:if>
                                                <c:if test="${3 == user.role}">
                                                    <option value="1">Admin</option>
                                                    <option value="2">Staff</option>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="about" required name="about"
                                                   placeholder="about" value="${user.role}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="number" id="yob" required name="yob"
                                                   placeholder="yob" value="${user.yob}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
