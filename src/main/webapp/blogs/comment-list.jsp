                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool-right">
                                    ...
                                    <a href="/comment?action=add" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                        <i class="zmdi zmdi-plus"></i>add comment
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-data2">
                                ...
                                <c:forEach items="${list}" var="com">
                                    <tr class="tr-shadow">
                                        ...
                                        <td>${com.post.title}</td>
                                        <td>
                                            <div class="table-data-feature">

                                                <a href="/comment?action=update&id=${com.id}" class="item" data-toggle="tooltip" data-placement="top"
                                                   title="Edit">
                                                    <i class="zmdi zmdi-edit"></i>
                                                </a>
                                                <a href="/comment?action=delete&id=${com.id}" class="item" data-toggle="tooltip" data-placement="top"
